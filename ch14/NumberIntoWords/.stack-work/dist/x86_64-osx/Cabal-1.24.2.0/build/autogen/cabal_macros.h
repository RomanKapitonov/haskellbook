...
/* package NumberIntoWords-0.1.0.0 */
#define VERSION_NumberIntoWords "0.1.0.0"
#define MIN_VERSION_NumberIntoWords(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "NumberIntoWords-0.1.0.0-61E0h2Zlnud6OvciIfi4ph"

#define CURRENT_PACKAGE_KEY "NumberIntoWords-0.1.0.0-61E0h2Zlnud6OvciIfi4ph"
